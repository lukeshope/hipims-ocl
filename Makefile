...
CC_FLAGS := -rdynamic -g -Wall -g3 -w -I/usr/local/cuda/include/ -I/usr/local/include/ -I/usr/include/gdal/ -I/opt/AMDAPP/include/ -I/usr/local/browndeer/include/ -std=c++0x $(MACROS)
